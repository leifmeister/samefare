...
trips = [
    models.Trip(
        ...
        car_type="suv",
        pickup_address="BSÍ Bus Terminal, Vatnsmýrarvegur 10, Reykjavík",
        dropoff_address="Akureyri Bus Terminal, Strandgata 39, Akureyri",
        description="Leaving from BSÍ at 08:00. Happy to stop at Goðafoss on the way.",
    ...
    models.Trip(
        ...
        car_type="suv",
        pickup_address="Akureyri Bus Terminal, Strandgata 39, Akureyri",
        dropoff_address="Hlemmur Square, Laugavegur 105, Reykjavík",
        description="Heading south after the weekend. Can stop briefly in Borgarnes.",
    ...
    models.Trip(
        ...
        car_type="electric",
        pickup_address="Háskóli Íslands (University), Sæmundargata, Reykjavík",
        dropoff_address="Selfoss Town Centre, Austurvegur, Selfoss",
        description="Silent electric ride down Route 1. Quick stop at the Selfoss supercharger.",
        allows_luggage=True, allows_pets=False, smoking=False,
    ),
    models.Trip(
        driver_id=anna.id,
        ...
        car_type="sedan",
        pickup_address="Selfoss N1 petrol station, Þingvallastræti 1, Selfoss",
        dropoff_address="Mjódd Bus Terminal, Reykjavík",
        description="Daily commute back to the city. Leaving Selfoss on the dot at 17:00.",
    ...
    models.Trip(
        ...
        car_type="4x4",
        pickup_address="Grandi Harbour, Grandagarður, Reykjavík",
        dropoff_address="Vík í Mýrdal village centre, Víkurbraut, Vík",
        description="South coast run. Stopping at Skógafoss and Reynisfjara black sand beach.",
        allows_luggage=True, allows_pets=True, smoking=False,
    ),
    models.Trip(
        driver_id=gunnar.id,
        ...
        car_make="Toyota", car_model="Land Cruiser", car_year=2019,
        car_type="suv",
        pickup_address="Fossvogur, Nauthólsvegur 100, Reykjavík",
        dropoff_address="Keflavík International Airport, Terminal Building",
        description="Airport drop-off run. Plenty of boot space. Will wait 5 mins if you message ahead.",
        allows_luggage=True, allows_pets=False, smoking=False,
    ),
    models.Trip(
        driver_id=helga.id,
        ...
        car_type="sedan",
        pickup_address="Hlemmur Square, Laugavegur 105, Reykjavík",
        dropoff_address="Borgarnes Swimming Pool, Þórbergsgata, Borgarnes",
        description="Weekend trip home. Can pick up anywhere along Laugavegur.",
        allows_luggage=True, allows_pets=False, smoking=False,
    ),
    models.Trip(
        driver_id=sigrid.id,
        ...
        car_make="Kia", car_model="Sportage", car_year=2021,
        car_type="suv",
        pickup_address="Akureyri Campsite, Þórunnarstraeti 23, Akureyri",
        dropoff_address="Húsavík Whale Museum, Hafnarstett 1, Húsavík",
        description="Day trip to Húsavík for whale watching. Return ride same evening available too.",
        allows_luggage=True, allows_pets=True, smoking=False,
    ),
    models.Trip(
        driver_id=bjorn.id,
        ...
        car_type="electric",
        pickup_address="BSÍ Bus Terminal, Vatnsmýrarvegur 10, Reykjavík",
        dropoff_address="Höfn Harbour, Víkurbraut, Höfn",
        description="Full day drive to Höfn via Jökulsárlón glacier lagoon. One supercharger stop in Vík.",
        allows_luggage=True, allows_pets=False, smoking=False,
    ),
    models.Trip(
        driver_id=anna.id,
        ...
        car_make="Volkswagen", car_model="Golf", car_year=2020,
        car_type="sedan",
        pickup_address="Kringlan Shopping Centre, Kringlan 4–12, Reykjavík",
        dropoff_address="Hveragerði Geothermal Park, Breiðamörk, Hveragerði",
        description="Quick commute to Hveragerði. Happy to drop at the hot springs.",
        allows_luggage=False, allows_pets=False, smoking=False,
    ),
]
for t in trips:
